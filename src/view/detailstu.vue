      ...
      <div class="nav gWidth" id="third-nav" style="box-shadow: none">
        <el-menu default-active="2" class="elmenu" mode="horizontal" @select="handleSelect">
          <el-menu-item index="1">
            <router-link class="toHw" :to="{name:'submitHW',params:{id:uid,courseId:courseId,hwId:homework.hwId}}">
              提交作业
            </router-link>
            </el-menu-item>
          <el-menu-item index="2">
            <router-link class="toHw" :to="{name:'detailstu',params:{id:uid,courseId:courseId,hwId:homework.hwId}}">
              作业详情
            </router-link>
            </el-menu-item>
        </el-menu>
